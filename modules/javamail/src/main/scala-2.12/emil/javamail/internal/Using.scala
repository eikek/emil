...
object Using {
  ...
  /** Performs an operation using a resource, and then releases the resource, even if the
    * operation throws an exception. This method behaves similarly to Java's
    * try-with-resources.
    *
    * @param resource
    *   the resource
    ...
    * @return
    *   the result of the operation, if neither the operation nor releasing the resource
    *   throws
    */
